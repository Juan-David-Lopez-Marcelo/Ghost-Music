 ...
 * @author Usuario
 */
public class Proveedores_Tabla extends javax.swing.JFrame {

    /**
     * Creates new form Proveedores_Tabla
     */
    public Proveedores_Tabla() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Proveedores_Tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proveedores_Tabla().setVisible(true);
            }
        });
    }
